            ...
            <div
                ...
                <div className="relative bg-white rounded-lg shadow">
                    <div className='border-b py-5 flex justify-between px-5 items-center'>
                        ...
                        <button onClick={() => setHasabymModal(false)} type="button" className="absolute right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white">
